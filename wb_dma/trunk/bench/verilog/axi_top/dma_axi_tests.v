...
task sw_dma1;
    ...
    for(chunk_sz=0;chunk_sz<chunk_sz_max;chunk_sz=chunk_sz+1)
       begin
    	...
    	m0.axi_wr1(`REG_BASE + `CH0_ADR0,32'h0000_0000);
    	m0.axi_wr1(`REG_BASE + `CH0_ADR1,32'h0000_4000);
    	...
    	m0.axi_rd1(`REG_BASE + `INT_SRCA, d1);
    	d0 = 32'h0000_0001;
    	if( d1 !== d0 )
    	   begin
    	...
    	m0.axi_rd1(`REG_BASE + `CH0_CSR, d1);
    	...
    	for(n=0;n<tot_sz;n=n+1)
    	   begin
    		...
    		if( d1 !== d0 )
    		   begin
    			$display("ERROR: Data[%0d] Mismatch: Expected: addr0:%x,data0:%x, Got: addr1:%x,data1:%x (%0t)",
    			n, n,d0, (32'h0000_1000 + n),d1, $time);
			$display("s0.mem[%x]=%x  s0.mem[%x]=%x  s1.mem[%x]=%x  s1.mem[%x]=%x",
    			n, s0.mem[ n ], (32'h0000_1000 + n), s0.mem[32'h0000_1000 + n ], n, s1.mem[ n ], (32'h0000_1000 + n), s1.mem[32'h0000_1000 + n ]);
    			error_cnt = error_cnt + 1;
    		   end
    	   end
...
task sw_dma2;
    ...
    for(chunk_sz=0;chunk_sz<chunk_sz_max;chunk_sz=chunk_sz+1)
       ...
       begin
    	...
    	m0.axi_wr1(`REG_BASE + `INT_MASKB,32'hffff_ffff);
    	m0.axi_wr1(`REG_BASE + `CH0_TXSZ, {chunk_sz, tot_sz});
    	m0.axi_wr1(`REG_BASE + `CH0_ADR0,32'h0000_0000);
    	m0.axi_wr1(`REG_BASE + `CH0_ADR1,32'h0000_4000);
    	m0.axi_wr1(`REG_BASE + `CH0_CSR,
    	...
    	m0.axi_rd1(`REG_BASE + `INT_SRCB, d1);
    	d0 = 32'h0000_0001;
    	if( d1 !== d0 )
    	   begin
...
task hw_dma1;
    ...
    begin
    	...
    	m0.axi_wr1(`REG_BASE + `INT_MASKA,32'h0000_ffff);
    	m0.axi_wr1(`REG_BASE + `CH0_TXSZ, {chunk_sz, tot_sz});
    	m0.axi_wr1(`REG_BASE + `CH0_ADR0,32'h0000_0000);
    	m0.axi_wr1(`REG_BASE + `CH0_ADR1,32'h0000_4000);
    	m0.axi_wr1(`REG_BASE + `CH0_CSR,
       ...
       begin
    	...
    	fork
    	   begin
    		...
    		for(lm=0;lm < k;lm=lm+1)
    		   begin
    			repeat(del)	@(posedge clk);
    			#1;
    			dma_req_i[0] = 1;
    			while(!dma_ack_o[0])	@(posedge clk);
    			#1;
    			dma_req_i[0] = 0;
    		   end
    	   ...
    	   begin
    		...
    		while(!u_dma.u_dma.dma_done_all)	@(posedge clk);
...
task hw_dma2;
    ...
    reg	[7:0]	mode;
    reg	[15:0]	chunk_sz, tot_sz;
    integer		i, n,lm0, lm1, lm2, lm3, k,rep,del;
    ...
    del = 0;
    	...
    	m0.axi_wr1(`REG_BASE + `CH0_CSR, 32'h0);
    	m0.axi_wr1(`REG_BASE + `CH1_CSR, 32'h0);
    	m0.axi_wr1(`REG_BASE + `CH2_CSR, 32'h0);
    	m0.axi_wr1(`REG_BASE + `CH3_CSR, 32'h0);
    ...
    begin
    	...
    	m0.axi_wr1(`REG_BASE + `PTR0, 32'h0000_0000);
    	m0.axi_wr1(`REG_BASE + `CH0_TXSZ, {chunk_sz, 16'h0fff});
    	m0.axi_wr1(`REG_BASE + `CH0_ADR0,32'h0000_ffff);
    	m0.axi_wr1(`REG_BASE + `CH0_ADR1,32'h0000_ffff);

    	m0.axi_wr1(`REG_BASE + `CH0_CSR,
    			//{25'h0000001, 4'b0111, 2'b00, 1'b1});
    			{12'h0000, 3'b010, 1'b0, 9'h001, 4'b0111, 2'b00, 1'b1});

    	m0.axi_wr1(`REG_BASE + `PTR1, 32'h0000_0020);
    	m0.axi_wr1(`REG_BASE + `CH1_TXSZ, {chunk_sz, 16'h0fff});
    	m0.axi_wr1(`REG_BASE + `CH1_ADR0,32'h0000_ffff);
    	m0.axi_wr1(`REG_BASE + `CH1_ADR1,32'h0000_ffff);

    	m0.axi_wr1(`REG_BASE + `CH1_CSR,
    			//{25'h0000001, 4'b0111, 2'b00, 1'b1});
    			{12'h0000, 3'b010, 1'b0, 9'h001, 4'b0111, 2'b00, 1'b1});

    	m0.axi_wr1(`REG_BASE + `PTR2, 32'h0000_0040);
    	m0.axi_wr1(`REG_BASE + `CH2_TXSZ, {chunk_sz, 16'h0fff});
    	m0.axi_wr1(`REG_BASE + `CH2_ADR0,32'h0000_ffff);
    	m0.axi_wr1(`REG_BASE + `CH2_ADR1,32'h0000_ffff);

    	m0.axi_wr1(`REG_BASE + `CH2_CSR,
    			//{25'h0000001, 4'b0111, 2'b00, 1'b1});
    			{12'h0000, 3'b010, 1'b0, 9'h001, 4'b0111, 2'b00, 1'b1});

    	m0.axi_wr1(`REG_BASE + `PTR3, 32'h0000_0060);
    	m0.axi_wr1(`REG_BASE + `CH3_TXSZ, {chunk_sz, 16'h0fff});
    	m0.axi_wr1(`REG_BASE + `CH3_ADR0,32'h0000_ffff);
    	m0.axi_wr1(`REG_BASE + `CH3_ADR1,32'h0000_ffff);

    	m0.axi_wr1(`REG_BASE + `CH3_CSR,
    			//{25'h0000001, 4'b0111, 2'b00, 1'b1});
    			{12'h0000, 3'b010, 1'b0, 9'h001, 4'b0111, 2'b00, 1'b1});
    	...
    	fork
    	   ...
    	   begin
    		repeat(5)	@(posedge clk);
    		for(lm1=0;lm1 < k;lm1=lm1+1)
    		   begin
    			repeat(del)	@(posedge clk);
    			#1;
    			dma_req_i[1] = 1;
    			while(!dma_ack_o[1])	@(posedge clk);
    			#1;
    			dma_req_i[1] = 0;
    		   end
    	   end
    	   ...
    	   begin
    		repeat(5)	@(posedge clk);
    		for(lm2=0;lm2 < k;lm2=lm2+1)
    		   begin
    			repeat(del)	@(posedge clk);
    			#1;
    			dma_req_i[2] = 1;
    			while(!dma_ack_o[2])	@(posedge clk);
    			#1;
    			dma_req_i[2] = 0;
    		   end
    	   end
    	   ...
    	   begin
    		repeat(5)	@(posedge clk);
    		for(lm3=0;lm3 < k;lm3=lm3+1)
    		   begin
    			repeat(del)	@(posedge clk);
    			#1;
    			dma_req_i[3] = 1;
    			while(!dma_ack_o[3])	@(posedge clk);
    			#1;
    			dma_req_i[3] = 0;
    		   end
    	   end
    	   ...
    	   begin
    		...
    		if(int_src[0])
    		   begin
    			m0.axi_rd1(`REG_BASE + `CH0_CSR, d0);
    			i=i+1;
    		...
    		if(int_src[1])
    		   begin
    			m0.axi_rd1(`REG_BASE + `CH1_CSR, d0);
    			i=i+1;
    			for(n=0;n<tot_sz*2;n=n+1)
    			   begin
    		...
    		if(int_src[2])
    		   begin
    			m0.axi_rd1(`REG_BASE + `CH2_CSR, d0);
    			i=i+1;
    			for(n=0;n<tot_sz*2;n=n+1)
    			   begin
    		...
    		if(int_src[3])
    		   begin
    			m0.axi_rd1(`REG_BASE + `CH3_CSR, d0);
    			i=i+1;
    			for(n=0;n<tot_sz*2;n=n+1)
    			   begin
...
task hw_dma3;
    ...
    reg	[7:0]	mode;
    reg	[15:0]	chunk_sz, tot_sz;
    integer		odd, i, iz, n,lm0, lm1, lm2, lm3, k, k1, rep,del;
    reg	[31:0]	int_src, d0,d1;
	...
	tb_chunk_sz = chunk_sz;
    	...
    	m0.axi_wr1(`REG_BASE + `PTR1, 32'h0000_0040);
    	m0.axi_wr1(`REG_BASE + `CH1_TXSZ, {chunk_sz, 16'h0fff});
    	m0.axi_wr1(`REG_BASE + `CH1_ADR0,32'h0000_ffff);
    	m0.axi_wr1(`REG_BASE + `CH1_ADR1,32'h0000_ffff);
    	...
    	m0.axi_wr1(`REG_BASE + `PTR2, 32'h0000_0080);
    	m0.axi_wr1(`REG_BASE + `CH2_TXSZ, {chunk_sz, 16'h0fff});
    	m0.axi_wr1(`REG_BASE + `CH2_ADR0,32'h0000_ffff);
    	m0.axi_wr1(`REG_BASE + `CH2_ADR1,32'h0000_ffff);
    	...
    	m0.axi_wr1(`REG_BASE + `PTR3, 32'h0000_00c0);
    	m0.axi_wr1(`REG_BASE + `CH3_TXSZ, {chunk_sz, 16'h0fff});
    	m0.axi_wr1(`REG_BASE + `CH3_ADR0,32'h0000_ffff);
    	m0.axi_wr1(`REG_BASE + `CH3_ADR1,32'h0000_ffff);
	...
	tb_k1= k1;
    	...
    	fork
    	   begin
    		repeat(5)	@(posedge clk);
    		for(lm0=0;lm0 < k1+1;lm0=lm0+1)
    		   begin
			tb_lm0 = lm0;
    			repeat(del)	@(posedge clk);
    			#1;

    			if(lm0==iz)	dma_nd_i[0] = 1;
    			else
    			if(lm0==(iz*2))	dma_nd_i[0] = 1;
    			else
    			if(lm0==(iz*3))	dma_nd_i[0] = 1;
    			else
    			if(lm0==(iz*4))	dma_nd_i[0] = 1;
    			else		dma_req_i[0] = 1;
    			...
    			while(!dma_ack_o[0] & (lm0 < k1))	@(posedge clk);
    			#1;
    			dma_req_i[0] = 0;
    			dma_nd_i[0] = 0;
    		   end
    	   ...
    	   begin
    		repeat(5)	@(posedge clk);
    		for(lm1=0;lm1 < k1;lm1=lm1+1)
    		   begin
			tb_lm1 = lm1;
    			repeat(del)	@(posedge clk);
    			#1;
    			if(lm1==k-1)	dma_nd_i[1] = 1;
    			if(lm1==(k*2)-1)	dma_nd_i[1] = 1;
    			if(lm1==(k*3)-1)	dma_nd_i[1] = 1;
    			if(lm1==(k*4)-1)	dma_nd_i[1] = 1;
    			dma_req_i[1] = 1;
    			while(!dma_ack_o[1])	@(posedge clk);
    			#1;
    			dma_req_i[1] = 0;
    	   ...
    	   begin
    		repeat(5)	@(posedge clk);
    		for(lm2=0;lm2 < k1+1;lm2=lm2+1)
    		   begin
			tb_lm2 = lm2;
    			repeat(del)	@(posedge clk);
    			#1;

    			if(lm2==k)	dma_nd_i[2] = 1;
    			else
    			if(lm2==(k*2))	dma_nd_i[2] = 1;
    			else
    			if(lm2==(k*3))	dma_nd_i[2] = 1;
    			else
    			if(lm2==(k*4))	dma_nd_i[2] = 1;
    			else		dma_req_i[2] = 1;
    			...
    			while(!dma_ack_o[2] & (lm2 < k1))	@(posedge clk);
    			#1;
    			dma_req_i[2] = 0;
    			dma_nd_i[2] = 0;
    		   end
    	   ...
    	   begin
    		repeat(5)	@(posedge clk);
    		for(lm3=0;lm3 < k1;lm3=lm3+1)
    		   begin
			tb_lm3 = lm3;
    			repeat(del)	@(posedge clk);
    			#1;
    			if(lm3==k-1)	dma_nd_i[3] = 1;
    			if(lm3==(k*2)-1)	dma_nd_i[3] = 1;
    			if(lm3==(k*3)-1)	dma_nd_i[3] = 1;
    			if(lm3==(k*4)-1)	dma_nd_i[3] = 1;
    			dma_req_i[3] = 1;
    			while(!dma_ack_o[3])	@(posedge clk);
    			#1;
    			dma_req_i[3] = 0;
...
task hw_dma3;														
	...
	begin
		...
		fork
		   begin
			repeat(5)	@(posedge clk);						//通道CH0和CH2，先nd_i=1，然后过一个时钟周期nd_i=0，再过一个时钟周期req_i才为1，模拟的是只有nd没有请求，也就是ndnr
			for(lm0=0;lm0 < k1+1;lm0=lm0+1)						//这种情况下会直接跳过这一个chunk，跳到下一段descriptor
			   begin
				repeat(del)	@(posedge clk);
				#1;
		   ...
		   begin
			repeat(5)	@(posedge clk);						//通道CH1和CH3，nd_i和req_i同时为1，模拟的是既有nd信号也有req_i信号，也就是ndr
			for(lm1=0;lm1 < k1;lm1=lm1+1)						//这种情况下不会直接跳转，而是等到此次chunk执行完后再跳转到下一段descriptor
			   begin
				repeat(del)	@(posedge clk);
				#1;
				if(lm1==k-1)	dma_nd_i[1] = 1;
		   ...
		   begin
			...
			if(int_src[1])												//通道CH1和CH3除了验证数据搬运正确和CSR寄存器写回正确外，还验证了WB写回内存正确
			   begin
				i=i+1;
				for(n=0;n<tot_sz*2;n=n+1)
				   begin
...
task sw_ext_desc1;
    ...
    begin
    	...
    	m0.axi_wr1(`REG_BASE + `PTR0, 32'h0000_0020);
    	m0.axi_wr1(`REG_BASE + `CH0_TXSZ, {chunk_sz, 12'h0});
    	m0.axi_wr1(`REG_BASE + `CH0_ADR0,32'h0000_0080);
    	m0.axi_wr1(`REG_BASE + `CH0_ADR1,32'h0000_4000);
    	...
    	m0.axi_wr1(`REG_BASE + `PTR1, 32'h0000_0000);
    	m0.axi_wr1(`REG_BASE + `CH1_TXSZ, {chunk_sz, 12'h0});
    	m0.axi_wr1(`REG_BASE + `CH1_ADR0,32'h0000_0080);
    	m0.axi_wr1(`REG_BASE + `CH1_ADR1,32'h0000_4000);
    ...
    begin
    	...
    	m0.axi_rd1(`REG_BASE + `CH1_CSR, d1);
    	d0 = {24'h0064_089, 1'b1, mode[1:0], 1'b0};
    	if( d1 !== d0 )
    	   begin
...
task arb_test1;
    ...
    m0.axi_rd1(`REG_BASE + `INT_SRCA, d0);
    ...
    $display("a: %0d", a);
    	...
    	m0.axi_wr1(`REG_BASE + `CH0_TXSZ, {chunk_sz0, tot_sz});
    	m0.axi_wr1(`REG_BASE + `CH0_ADR0,32'h0000_0000);
    	m0.axi_wr1(`REG_BASE + `CH0_ADR1,32'h0000_4000);

    	m0.axi_wr1(`REG_BASE + `CH1_TXSZ, {chunk_sz1, tot_sz});
    	m0.axi_wr1(`REG_BASE + `CH1_ADR0,32'h0000_0080);
    	m0.axi_wr1(`REG_BASE + `CH1_ADR1,32'h0000_4080);

    	m0.axi_wr1(`REG_BASE + `CH2_TXSZ, {chunk_sz2, tot_sz});
    	m0.axi_wr1(`REG_BASE + `CH2_ADR0,32'h0000_0100);
    	m0.axi_wr1(`REG_BASE + `CH2_ADR1,32'h0000_4100);

    	m0.axi_wr1(`REG_BASE + `CH3_TXSZ, {chunk_sz3, tot_sz});
    	m0.axi_wr1(`REG_BASE + `CH3_ADR0,32'h0000_0180);
    	m0.axi_wr1(`REG_BASE + `CH3_ADR1,32'h0000_4180);
    	...
    	while(ptr!=4)
    	   begin
    		...
    		case(d0[1:0])
    		   0: m0.axi_rd1(`REG_BASE + `CH0_CSR, d0);
    		   1: m0.axi_rd1(`REG_BASE + `CH1_CSR, d0);
    		   2: m0.axi_rd1(`REG_BASE + `CH2_CSR, d0);
    		   3: m0.axi_rd1(`REG_BASE + `CH3_CSR, d0);
    		endcase
    ...
    //$display("k=%0d",k);
    	...
    	fork
    	   ...
    	   begin	// Hardware Handshake Channel 1
    		repeat(5)	@(posedge clk);
    		for(lm1=0;lm1 < (k + rest_del_t + 1);lm1=lm1+1)
    		   begin
    			repeat(del)	@(posedge clk);
    			#1;
    			dma_req_i[1] = 1;
...
begin
	...
	fork
			...
			if(dma_nd_i[0]==1)
			   begin
				...
				dma_req_i[0] = 1;
                        ...
                        wt = 0;
			while(!dma_ack_o[0] & (lm0 < k1) & (wt < 100000)) begin @(posedge clk); wt = wt + 1; end
                        if (wt >= 100000) begin
                           $display("ERROR: TIMEOUT waiting dma_ack_o[0] @%0t", $time);
                           error_cnt = error_cnt + 1;
                           disable timeout_abort_hw_dma3;
                        end
			#1;
			dma_req_i[0] = 0;
			dma_nd_i[0] = 0;
	   ...
	   begin
		...
		for(lm1=0;lm1 < k1;lm1=lm1+1)
		   begin
			...
			dma_req_i[1] = 1;
                        wt = 0;
			while(!dma_ack_o[1] & (wt < 100000)) begin @(posedge clk); wt = wt + 1; end
                        if (wt >= 100000) begin
                           $display("ERROR: TIMEOUT waiting dma_ack_o[1] @%0t", $time);
                           error_cnt = error_cnt + 1;
                           disable timeout_abort_hw_dma3;
                        end
			#1;
			...
			if(dma_nd_i[2]==1)
			   begin
				...
				dma_req_i[2] = 1;
                        ...
                        wt = 0;
			while(!dma_ack_o[2] & (lm2 < k1) & (wt < 100000)) begin @(posedge clk); wt = wt + 1; end
                        if (wt >= 100000) begin
                           $display("ERROR: TIMEOUT waiting dma_ack_o[2] @%0t", $time);
                           error_cnt = error_cnt + 1;
                           disable timeout_abort_hw_dma3;
                        end
			#1;
	   ...
	   begin
		...
		for(lm3=0;lm3 < k1;lm3=lm3+1)
		   begin
			...
			dma_req_i[3] = 1;
                        wt = 0;
			while(!dma_ack_o[3] & (wt < 100000)) begin @(posedge clk); wt = wt + 1; end
                        if (wt >= 100000) begin
                           $display("ERROR: TIMEOUT waiting dma_ack_o[3] @%0t", $time);
                           error_cnt = error_cnt + 1;
                           disable timeout_abort_hw_dma3;
                        end
			#1;
	   ...
	   begin: timeout_abort_hw_dma3
	   for(i=0;i<4;i=i)
	   begin
		repeat(5)	@(posedge clk);
                wt = 0;
		while(!inta_o & (wt < 100000)) begin @(posedge clk); wt = wt + 1; end
                if (wt >= 100000) begin
                   $display("ERROR: TIMEOUT waiting inta_o @%0t", $time);
                   error_cnt = error_cnt + 1;
                   disable timeout_abort_hw_dma3;
                end
		m0.axi_rd1(`REG_BASE + `INT_SRCA, int_src);
